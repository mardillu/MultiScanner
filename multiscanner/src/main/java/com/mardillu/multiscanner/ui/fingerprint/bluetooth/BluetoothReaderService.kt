package com.mardillu.multiscanner.ui.fingerprint.bluetooth
...
class BluetoothReaderService(context: Context?, handler: Handler) {
    ...
    private fun connectionFailed() {
        ...
        val bundle = Bundle()
        bundle.putString(TOAST, "Unable to connect to the Fingerprint scanner")
        msg.data = bundle
        mHandler.sendMessage(msg)
    }
    ...
    private fun connectionLost() {
        ...
        val msg = mHandler.obtainMessage(MESSAGE_TOAST)
        val bundle = Bundle()
        bundle.putString(TOAST, "Fingerprint scanner disconnected!")
        msg.data = bundle
        mHandler.sendMessage(msg)
    }
